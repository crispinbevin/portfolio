    ...
    return (
        <>
            <div className="section bg-zinc-900 min-h-screen text-white font-inter ">
                ...
                <div className="main-wrapper xl:mx-64 max-xl:mx-32 max-sm:mx-8 pt-32 flex flex-col justify-between lg:min-h-screen">
                    <div className="content flex flex-col gap-10">
                        ...
                        <div className="text-zinc-400 mr-90 max-lg:mr-32 max-sm:mr-8 leading-9">
                            Full-stack developer and AI/ML enthusiast, crafting
                            sleek apps with React, Python, and machine learning.
                            Currently at home leveling up my stack and
                            sharpening my edge — open to joining a
                            team/organization where I can build cool things that
                            matter. When I'm not coding, I'm either moving heavy
                            circles around, bumping my head to vibrating air, or
                            pointing and clicking at moving pixels very quickly.
                        </div>
                    </div>
                    <div
                        className="pointer bg-amber-50 w-7.5 rounded-full mb-8 self-center flex px-2"
                        onClick={scrollToSkills}
                    >
                                ...
                                <div className="list-wrapper mx grid grid-cols-3 max-md:grid-cols-1 gap-12">
                                    <div className="list-thing flex flex-col gap-8 p-8 hover:bg-zinc-800 transition-all duration-300 rounded-2xl">
                                        ...
                                        <div className="text-zinc-400 leading-6">
                                            ...
                                            for classification, prediction, and
                                            automation. Skilled in CNN, XGBoost,
                                            and Decision Trees, with experience
                                            in optimizing models through
                                            hyperparameter tuning and transfer
                                            learning. Passionate about computer
                                            vision using OpenCV for tasks like
                                            pose detection and image processing.
                                        </div>
                                    ...
                                    <div className="list-thing flex flex-col gap-8 p-8 hover:bg-zinc-800 transition-all duration-300 rounded-2xl">
                                        ...
                                        <div className="text-zinc-400 leading-6">
                                            React developer who loves building
                                            sleek, fast, and responsive UIs with{" "}
                                            <span className="text-zinc-100 font-bold">
                                                React
                                            </span>{" "}
                                            and{" "}
                                            ...
                                            . Big on clean code, reusable
                                            components, and smooth user
                                            experiences. Always experimenting
                                            with new tech, optimizing
                                            performance, and making the web a
                                            better place—one component at a
                                            time.
                                        </div>
                                        <div className="flex gap-6 flex-wrap">
                                    ...
                                    <div className="list-thing flex flex-col gap-8 p-8 hover:bg-zinc-800 transition-all duration-300 rounded-2xl">
                                        ...
                                        <div className="text-zinc-400 leading-6">
                                            ...
                                            . Experienced in data wrangling,
                                            preprocessing, and feature
                                            engineering to enhance model
                                            accuracy. Skilled in data
                                            visualization with Matplotlib,
                                            Seaborn, and Plotly to communicate
